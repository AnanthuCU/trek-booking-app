...
// import { CounsellingType, Mark, View } from "../../types";
...
//   markFilterSelect: Mark[];
//   setMarkFilterSelect: React.Dispatch<React.SetStateAction<Mark[]>>;
//   marks: Mark[];
// };
...
//     };
//   });
//   const markData = marks.map((item, index) => {
//     return {
//       name: item,
//       id: `${index}`,
//     };
...
//           filterSelect={markFilterSelect}
//           setFilterSelect={
//             setMarkFilterSelect as React.Dispatch<
